...
#endif
                VL_FATAL_MT("mux21.v", 48, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("mux21.v", 48, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("mux21.v", 48, "", "NBA region did not converge.");
            }
